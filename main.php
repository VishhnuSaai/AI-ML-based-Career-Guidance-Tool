...
<?php include 'header.php'?>
		...
		<div id="home" class="hero-area">
			...
			<!-- Backgound Image -->
			<div class="bg-image bg-parallax overlay" style="background-image:url(./img/bg.jpg); background-repeat: repeat-y; width:100%; height: 656px;"></div>
			<!-- /Backgound Image -->
			...
			<div class="container">
				...
				<div class="row">
					<div class="section-header text-center">
						...
						<h2 style="margin-top: 100px; font-size: 50px;">Welcome to Atharva.in</h2>
						...
						<p class="lead"><b style="color: rgb(56, 48, 48);">Atharva.in</b> is one stop destination <br>in helping you understand yourself, the best career for you <br> and providing all the resources in the process.</p>
					</div>
				</div>	
					...
					<div class="col-md-4">
						<div class="feature">
							...
							<div class="feature-content">
								...
								<?php else: ?>
									<a href="http://127.0.0.1/INTELLIGENT-CAREER-GUIDANCE-SYSTEM/login.php"><h4>Career Prediction</h4></a>
					...
					<div class="col-md-4">
						...
						<i class="feature-icon fa "><span>&#x1F50E;&#xFE0E;</span></i>
							<div class="feature-content">
								...
								<p>Discover and explore your career interests, search for jobs, and find valuable information to guide your career journey.</p>
							</div>
						</div>
					</div>
					<!-- /feature -->
