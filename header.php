			...
			<div class="container">
				...
				<div class="navbar-header">
					...
					<div class="navbar-brand">
						<a class="logo" href="main.php">Atharva.in</a>
					</div>
					<!-- /Logo -->
					...
					<ul class="main-menu nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            ...
                            <div class="dropdown-content">
								<a href="http://127.0.0.1/INTELLIGENT-CAREER-GUIDANCE-SYSTEM/login.php">Career Prediction</a>
                                <a href="http://127.0.0.1/INTELLIGENT-CAREER-GUIDANCE-SYSTEM/courses.php">Courses</a>
                                <a href="http://127.0.0.1/INTELLIGENT-CAREER-GUIDANCE-SYSTEM/blog.php">Knowledge Network</a>
								<a href="http://127.0.0.1/INTELLIGENT-CAREER-GUIDANCE-SYSTEM/jobs.php">Career Guidance</a>
					...
					<ul class="main-menu nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            ...
                            <div class="dropdown-content">
								...
								<a href="jobs.php">Career Guidance</a>
